                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6 col-md-3">
                                ...
                                <ul class="nav-vrt white opc none-padding">
                                    <li>
                                        <a href="/welcome" class="btn-material">Home</a>
                                    </li>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="footer-brand">
                                            <img src="{{ asset('pengguna/html/images/pop3.png') }}" alt="">
                                        </div>
                ...
                <div class="row">
                    <div class="container">
                        <div class="row">
                            <div class="col-md-6">
                                <span class="copy">
                                    © 2021 PPL Protect Our Pets. All rights reserved.
                                </span>
                            </div>
